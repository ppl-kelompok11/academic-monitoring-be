...
CREATE TABLE IF NOT EXISTS "cities" (
  ...
  "active" boolean NOT NULL DEFAULT true,
  PRIMARY KEY("id"),
  CONSTRAINT "city_province_foreign" FOREIGN KEY ("province_id") REFERENCES "provinces" ("id")
);

DROP INDEX IF EXISTS "cities_province_id_index";
CREATE INDEX "cities_province_id_index" ON "cities"("province_id");
